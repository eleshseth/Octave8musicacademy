        ...
        <div className='relative'>
          ...
          <div className='border-t-4 border-foreground'>
            {Array.from({ length: frets }).map((_, fretIndex) => (
              <div
                key={fretIndex}
                className='flex border-b border-muted-foreground/30'>
        ...
        <div className='container mx-auto px-4 py-8'>
          <div className='mb-8'>
            ...
            <p className='text-xl text-muted-foreground'>
              Master guitar chords with interactive diagrams and detailed
              fingering guides
            </p>
          </div>
              ...
              <Card
                ...
                <CardHeader className='pb-2'>
                  <div className='flex justify-between items-start mb-2'>
                    <Badge
                      variant='outline'
                      className={getDifficultyColor(chord.difficulty)}>
                      {chord.difficulty}
                    </Badge>
                    <div className='text-2xl font-bold text-customGreen group-hover:text-customGreen/80 transition-colors'>
                      {chord.symbol}
                    </div>
                  </div>
                ...
                <CardContent>
                  ...
                  <Button
                    variant='outline'
                    className='w-full group-hover:text-primary-foreground group-hover:bg-customGreen transition-colors'>
