...
const Tabs = () => {
  ...
  const filteredTabs = allTabs.filter(tab => {
    ...
    const matchesDifficulty = selectedDifficulty === "all" || tab.difficulty === selectedDifficulty;
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-xl text-muted-foreground">
            Discover and master thousands of guitar tabs from your favorite artists
          </p>
        </div>
        ...
        {filteredTabs.length === 0 && (
          <div className="text-center py-12">
            <p className="text-xl text-muted-foreground">No tabs found matching your search criteria.</p>
