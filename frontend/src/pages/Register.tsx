      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center space-x-2 group">
            <Guitar className="h-10 w-10 text-primary transition-transform group-hover:rotate-12" />
          ...
          <p className="text-muted-foreground">Join thousands of guitar learners today</p>
        </div>
