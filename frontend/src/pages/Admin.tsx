        ...
        <div className='container mx-auto px-4 py-8'>
          <div className='mb-8'>
            <div className='flex items-center justify-between'>
              <div>
                <h1 className='text-3xl font-bold flex items-center gap-3 bg-customGreen bg-clip-text text-transparent'>
                  <Guitar className='h-8 w-8 text-customGreen' />
                  Admin Dashboard
                </h1>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8'>
            {stats.map((stat, index) => (
              <div
                key={index}
                className='bg-card/50 backdrop-blur border border-border/50 rounded-lg p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1'>
                <div className='flex items-center justify-between'>
                  <div>
                    ...
                    <p className='text-sm text-customGreen mt-1'>
                      {stat.change} from last month
                    </p>
                  </div>
                  <div className='h-12 w-12 bg-customGreen/10 rounded-lg flex items-center justify-center'>
                    <stat.icon className='h-6 w-6 text-customGreen' />
                  </div>
                </div>
              </div>
            ))}
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8'>
            ...
            <div className='bg-card/50 backdrop-blur border border-border/50 rounded-lg p-6'>
              ...
              <div className='grid grid-cols-2 gap-3'>
                <Button
                  variant='outline'
                  className='h-auto p-4 flex flex-col items-center gap-2 hover:bg-customGreen hover:text-primary-foreground transition-colors'>
